...
$ASSEST_QUOTE_FORMAT = [
    ...
    'flyer_1' => esc_url(plugin_dir_url(dirname(__FILE__)) . 'public/assets/flyer/flyer-1.png'),
    'flyer_2' => esc_url(plugin_dir_url(dirname(__FILE__)) . 'public/assets/flyer/flyer-2.png'),
    'flyer_3' => esc_url(plugin_dir_url(dirname(__FILE__)) . 'public/assets/flyer/flyer-3.png'),
];
