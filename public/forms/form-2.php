...
<form id="certified-form-2" method="POST" action="<?php echo admin_url('admin-ajax.php'); ?>">
  ...
  <fieldset>
    ...
    <br>
    <div class="form-row">
      <h4>Si prefieres utilizar un diseño personalizado, descarga <a href="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)))   . 'assets/template/Ins-flyer-1.jpg'; ?>" download id="downloadTemplate">AQUÍ</a>  la guía para que hagas
