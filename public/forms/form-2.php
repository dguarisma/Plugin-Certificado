...
<style>
 ...
 input[type="submit"]:hover {
  ...
  #certified-form-2 .loader-text {
    color: #4CAF50;
    font-family: system-ui;
  }

  #certified-form-2 .loader-text:after {
    content: 'Loading';
    font-family: Muli, sans-serif !important;
      ...
      <div class="radio" style="text-align: center;color: #071041;">
        <label><input type="radio" name="optradio" id="optradio"
          ...
          <figure class="wpb_wrapper vc_figure">
            <a href="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-1.jpg"
              target="_self" class="vc_single_image-wrapper vc_box_rounded  vc_box_border_grey prettyphoto">
              <img width="1080" height="1528"
                src="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-1.jpg"
                class="vc_single_image-img attachment-full" alt=""
                srcset="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-1.jpg 1080w"
    ...
    <div class="column-quarter">
      <div class="radio" style="text-align: center;color: #071041;">
        <label><input type="radio" name="optradio" id="optradio"
          ...
          <figure class="wpb_wrapper vc_figure">
            <a href="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-2.jpg"
              target="_self" class="vc_single_image-wrapper vc_box_rounded  vc_box_border_grey prettyphoto"><img
                width="1080" height="1528"
                src="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-2.jpg"
                class="vc_single_image-img attachment-full" alt=""
                srcset="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-2.jpg 1080w"
                sizes="(max-width: 1080px) 100vw, 1080px"></a>
          </figure>
        </label>
      </div>
    ...
    <div class="column-quarter">
      <div class="radio" style="text-align: center;color: #071041;">
        <label><input type="radio" name="optradio" id="optradio"
          ...
          <figure class="wpb_wrapper vc_figure">
            <a href="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-3.jpg"
              target="_self" class="vc_single_image-wrapper vc_box_rounded  vc_box_border_grey prettyphoto"><img
                width="1080" height="1528"
                src="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-3.jpg"
                class="vc_single_image-img attachment-full" alt=""
                srcset="https://animal.pymdesarrollo.com/wp-content/uploads/2023/06/flyer-op-3.jpg 1080w"
                sizes="(max-width: 1080px) 100vw, 1080px"></a>
          </figure>
        </label>
      </div>
...
<script>
  ...
  document.getElementById('certified-form-2').addEventListener('submit', function (event) {
